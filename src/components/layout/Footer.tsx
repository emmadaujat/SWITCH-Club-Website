          ...
          <div className="grid flex-1 grid-cols-2 gap-8 sm:grid-cols-4">
            ...
            <div>
              <h3 className="text-sm font-bold uppercase tracking-wider">
                <span className="text-brand-pink align-centre mx-1">★</span>
                SWITCH
                <span className="text-brand-pink align-centre mx-1">★</span>
              </h3>
            ...
            <div>
              <h3 className="text-sm font-bold uppercase tracking-wider">
                <span className="text-brand-pink align-centre mx-1">★</span> Get Involved
                <span className="text-brand-pink align-centre mx-1">★</span>
              </h3>
              <ul className="mt-3 space-y-2">
                <li>
            ...
            <div>
              <h3 className="text-sm font-bold uppercase tracking-wider">
                <span className="text-brand-pink align-centre mx-1">★</span>
                Follow us <span className="text-brand-pink align-centre mx-1">★</span>
              </h3>
